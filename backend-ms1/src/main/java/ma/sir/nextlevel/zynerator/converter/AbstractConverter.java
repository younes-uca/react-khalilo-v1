package ma.sir.nextlevel.zynerator.converter;


import ma.sir.nextlevel.zynerator.bean.Etablissement;
import ma.sir.nextlevel.zynerator.dto.EtablissementDto;

import ma.sir.nextlevel.zynerator.util.ListUtil;
import ma.sir.nextlevel.zynerator.audit.AuditBusinessObject;
import ma.sir.nextlevel.zynerator.bean.BusinessObject;
import ma.sir.nextlevel.zynerator.dto.AuditBaseDto;
import ma.sir.nextlevel.zynerator.dto.BaseDto;
import ma.sir.nextlevel.zynerator.util.DateUtil;
import ma.sir.nextlevel.zynerator.util.RefelexivityUtil;
import ma.sir.nextlevel.zynerator.util.StringUtil;
import ma.sir.nextlevel.zynerator.util.Utils;
